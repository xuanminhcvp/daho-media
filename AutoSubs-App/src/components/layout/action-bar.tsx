...
import { DaVinciConsolePanel } from "@/components/layout/davinci-console-panel"
        ...
        <Card className="p-3 sticky bottom-4 mx-4 z-50 shadow-lg bg-card">
            <div className="grid w-full gap-3">
                ...
                {!settings.isStandaloneMode ? (
                    // Timeline Mode: Track Selector + Console Panel
                        ...
                        <Popover open={openTrackSelector} onOpenChange={handleTrackSelectorOpen}>
                            <PopoverTrigger asChild>
                                <Button
                                    ...
                                    className="w-full h-[80px] justify-center dark:bg-background dark:hover:bg-accent"
                                    size="sm"
                                >
                            ...
                            <PopoverContent className="min-w-[320px] max-h-[50vh] p-0 overflow-hidden" align="center" side="top" sideOffset={8} collisionPadding={16}>
                                <TrackSelector inputTracks={inputTracks} />
                            </PopoverContent>
                        </Popover>

                        {/* Panel copy mã Lua để kết nối DaVinci Console */}
                        <DaVinciConsolePanel />
                    </div>
                ) : (
