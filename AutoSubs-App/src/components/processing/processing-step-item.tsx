...
export interface ProcessingStepProps {
    ...
    id?: string;
    onExportToFile?: () => void;
    /** Callback tải file Whisper Words (word-level timestamps) */
...
export function ProcessingStepItem({
    ...
    if (id === 'Complete' && onExportToFile && onExportWhisperWords && onAddToTimeline && settings && timelineInfo) {
        return <CompletionStepItem onExportToFile={onExportToFile} onExportWhisperWords={onExportWhisperWords} onAddToTimeline={onAddToTimeline} settings={settings} timelineInfo={timelineInfo} />;
    }
